...
export default function Goal() {
  ...
  // If there's an active goal, show the Active component
  if (activeGoal) {
    return (
      <Layout>
        <Active
        ...
        />
        {/* Only show Creation modal when showCreation is true */}
        {showCreation && (
          <Creation
  ...
  // No active goal, show the Creation component directly
  return (
    <Layout>
      <Creation
        onCreateGoal={handleCreateGoal}
